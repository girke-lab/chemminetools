...
(function($) {
	...
	$.csv2table={
		...
		loadImg  : (new Image()).src='/static/icons/icon-loadinfo.gif',  //Dafault loading IMG 
		sortNImg : (new Image()).src='/static/icons/icon-n.gif',         //Dafault sort IMG N
		sortDImg : (new Image()).src='/static/icons/icon-d-green.gif',   //Dafault sort IMG D 
		sortAImg : (new Image()).src='/static/icons/icon-a-green.gif',   //Dafault sort IMG A
		setting  : [],
		data     : [],
		_rowsAry : [],
		_doc     : document,
