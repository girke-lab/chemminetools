...
# from compounddb.models import PropertyField
from csv import writer
from cStringIO import StringIO
# fields = PropertyField.objects.all().values_list('source_tag', 'name')
...
parser.add_argument('-t','--test', help='debug mode', required=False)
